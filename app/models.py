...
clientes (id, primeiro_nome, ultimo_nome, email, cpf, fk_status, created_at, updated_at)
...
class Registros ( models.Model ):
    fk_tipoRegistro = models.ForeignKey(Veiculos, on_delete = models.CASCADE)
...
class Estacionamento ( models.Model ):
    fk_veiculos = models.ForeignKey(Veiculos, on_delete = models.CASCADE)
    fk_status = models.ForeignKey(Status, on_delete = models.CASCADE)
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField(auto_now = True)